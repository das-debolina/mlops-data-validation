...
**Course:** MLOps · Data Validation & Testing
**Tools:** Great Expectations 1.18, pytest 9
...
messy dataset. The screenshot below is generated by `make_report_assets.py`
from the real validation run; the fully styled Great Expectations Data Docs are
also produced at `gx/uncommitted/data_docs/local_site/index.html`.

![Great Expectations validation results](report_assets/gx_validation_results.png)

> To use the native Data Docs instead, run `python great_expectations_setup.py`,
> open `gx/uncommitted/data_docs/local_site/index.html` in a browser, and
> screenshot the validation result page.
...
| (rows) | Fully duplicated records (redundant copies) | 15 | 0.30% |
...
| `signup_date` datetime type | ❌ observed `str` | dates were never parsed; 242 invalid strings |
...
![pytest results](report_assets/pytest_results.png)
